  ...
  return (
    ...
    >
      ...
      <div className="flex items-center flex-none gap-x-[10px]">
        <span
          className="w-10 h-10 p-[3px] mx-[2px] hidden xs:flex items-center justify-center cursor-pointer textPrimary rounded-full bg-[var(--bg-active)] hover:opacity-80"
        ...
        <span
          className="w-10 h-10 rounded-full overflow-hidden hover:opacity-80 cursor-pointer"
          onClick={() => toast.warning("Chức năng này chưa được phát triển")}
        >
          <img
