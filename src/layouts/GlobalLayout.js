  ...
  return (
    <div className="h-screen">
      ...
      <div className="relative flex w-full hMain">
        ...
        <div className="w-full overflow-hidden mr-[var(--margin-contentRight)]">
        ...
        {isOpenSBR && (
          <div className="bgMain blActice stroke-slate-500 flex-none widthSBR h-full absolute right-0 top-0 bottom-0 z-[2]">
